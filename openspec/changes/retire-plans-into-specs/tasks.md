...
- [ ] 6.1 Run `openspec validate --all`.
- [ ] 6.2 Run the full gate in `AGENTS.md`.
- [ ] 6.3 Run a live export and a release build, and confirm the new specs describe what the artifact contains.

...
- **Name the mod in the snapshot manifest**, so a published snapshot states which plugin produced it rather than only which game.
- Keep the product-name guard. It catches a different game, which remains a real case.

...
Live definition counts: 1,273 `ItemData`, 193 `ThrowingPotionData`, 64 `EnchantmentData`, 3 `SimpleItemListAsset`, 0 standalone `MerchantCategory` rows. Placement fields are measured separately above.

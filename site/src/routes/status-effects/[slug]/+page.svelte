  ...
  <div class="border-border bg-card rounded-lg border p-5">
    ...
    <section class="border-border mt-6 border-t pt-5">
      ...
      <p class="text-muted-foreground mt-4 text-sm">
        Strength and duration are set on each reference to this effect, not on the effect itself.
        The numbers in this description are one example, and the same effect can be applied at
        different strengths by different sources.
      </p>
    </section>
  </div>

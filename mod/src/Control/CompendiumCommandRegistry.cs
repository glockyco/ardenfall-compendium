...
public sealed class CompendiumCommandRegistry : IDisposable
{
    ...
    public CompendiumCommandRegistry(
        ...
        System.Action<System.Collections.IEnumerator> startCoroutine)
    {
        if (startCoroutine is null) throw new ArgumentNullException(nameof(startCoroutine));
        ...
        var walk = new Entities.World.CellWalk(
            ...
            new Entities.World.ISceneFamily[]
            {
                ...
                new Entities.World.WorldSpawnFamily(),
                new Entities.World.SceneDialogueFamily(),
            });
        ...
        Register(new Handlers.MapCaptureCommand(runs, scenes, startCoroutine));

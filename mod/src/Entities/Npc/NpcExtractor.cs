            ...
            (record, rowId) =>
            {
                ...
                return new NpcSnapshotRow
                {
                    ...
                    Fields = new NpcSnapshot(
                        ...
                        DropRefs: record.DropRefs,
                        DropRefsProvenance: record.DropRefsProvenance,
                        DropRefsOwner: NullIfEmpty(record.DropRefsOwner),
                        StartingFactions: record.StartingFactions,
                        StartingFactionsProvenance: record.StartingFactionsProvenance,
                        StartingFactionsOwner: NullIfEmpty(record.StartingFactionsOwner),
                        StartingLevel: record.StartingLevel,
                        StartingLevelProvenance: record.StartingLevelProvenance,
                        StartingLevelOwner: NullIfEmpty(record.StartingLevelOwner),
                        MerchantRefs: record.MerchantRefs,
                        MerchantRefsProvenance: record.MerchantRefsProvenance,
                        MerchantRefsOwner: NullIfEmpty(record.MerchantRefsOwner),
                        MerchantGold: record.MerchantGold,
                        MerchantGoldProvenance: record.MerchantGoldProvenance,
                        MerchantGoldOwner: NullIfEmpty(record.MerchantGoldOwner),
                        MerchantCategories: record.MerchantCategories,
                        MerchantCategoriesProvenance: record.MerchantCategoriesProvenance,
                        MerchantCategoriesOwner: NullIfEmpty(record.MerchantCategoriesOwner)),

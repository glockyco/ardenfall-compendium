...
- Portal records may legitimately have no friendlyName. `PortalExtractor` reports `portalFriendlyNameMissing` and leaves `friendlyName` null rather than substituting the row id.
